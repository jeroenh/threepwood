...
urlpatterns = patterns('',
    ...
    url(r'^torrent/(?P<pk>\d+)/assign_client/$', 'threepwood.apps.collector.views.assign_client',  name='collector_torrent_assign_client'),
    url(r'^torrent/(?P<pk>\d+)/remove_client/$', 'threepwood.apps.collector.views.remove_client',  name='collector_torrent_remove_client'),
    ...
    url(r'^client/(?P<pk>\d+)/assign_torrents/$', 'threepwood.apps.collector.views.assign_torrents',  name='collector_client_assign_torrents'),



    url(r'^post_peers/$', 'threepwood.apps.collector.views.post_peers',  name='collector_post_peers'),
    url(r'^get_torrents/$', 'threepwood.apps.collector.views.get_torrents',  name='collector_get_torrents'),
